...
public class Collectible : MonoBehaviour
{
    ...
    void Start ()
    {
        if (!respawn && GameManager.itemsCollected[GetInstanceID()] == true)
    ...
    public IEnumerator PullToPlayer()
    {
        ...
        if (!respawn)
        {
            GameManager.itemsCollected[GetInstanceID()] = true;
            GameManager.collectedTypes[GetInstanceID()] = this.GetType();
        }
