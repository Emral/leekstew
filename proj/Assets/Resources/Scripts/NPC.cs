...
public class NPC : MonoBehaviour
{
    ...
    public virtual void OnGUI()
    {
        if (distToPlayer < talkDist && !GameManager.cutsceneMode && talkCooldown <= 0f)
        {
            ...
            GUI.DrawTexture(new Rect(pos.x - Screen.width * 0.025f, Screen.height - pos.y - Screen.width * 0.025f, Screen.width*0.05f, Screen.width * 0.05f), GameManager.talkButtonTex);
        }
    }
